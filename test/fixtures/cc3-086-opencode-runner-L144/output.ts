...
__patsy_temp_0: {
  ...
  if (error?.name === "APIError") {
    ...
    if (AUTH_ERROR_CODES.has(statusCode)) {
      __result = true;
      break __patsy_temp_0;
    }
    ...
    __result = message.includes("api key") || body.includes("api_key_invalid") || body.includes("invalid_api_key") || body.includes("invalid_argument") && (body.includes("api key") || body.includes("api_key"));
    break __patsy_temp_0;
  }
  __result = false;
  break __patsy_temp_0;
